...
<body>
    ...
    <main>
        <section id="home" class="hero container">
            ...
            <p>Full Stack Developer | Design Enthusiast | Problem Solver</p>
        ...
        <section id="projects" class="projects container">
            <h2 class="section-title" style="text-align: center; margin-bottom: 2rem;">My Projects</h2>
            <div class="projects-grid">
                ...
                <div class="project-card">
                    ...
                    <p>Real-time analytics dashboard with data visualization</p>
                    <div class="project-technologies">
                ...
                <div class="project-card">
                    ...
                    <p>AI-powered image recognition tool</p>
                    <div class="project-technologies">
